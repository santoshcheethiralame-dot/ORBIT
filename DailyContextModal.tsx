    ...
    <FocusTrap>
      <div className="fixed inset-0 z-[100]" role="dialog" aria-modal="true">
        <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-xl flex items-center justify-center p-4">
          <SpaceBackground />
          <div className="w-full max-w-2xl bg-zinc-900/50 border border-white/10 rounded-3xl p-8 shadow-2xl animate-float relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10 animate-fade-in">
                ...
                {(dayType === 'isa' || dayType === 'esa') && (
                  <div className="animate-fade-in">
                    <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider block mb-2">Focus Subject</label>
            ...
            <Button onClick={handleSubmit} className="w-full py-4 text-lg bg-white text-black hover:bg-zinc-200 border-none relative z-10 font-bold mt-6">
              Initialize Systems
            </Button>
          </div>
        </div>
